...
import { ArrowLeft, Save, Package, Eye, EyeOff } from "lucide-react"
...
const mockProducts = [
  {
    ...
    views: 45,
    sales: 2,
    description: "Prachtige vintage stoel van massief eikenhout, perfect voor elke woonkamer.",
  ...
  },
  {
    ...
    views: 23,
    sales: 1,
    description: "Elegante moderne tafel van walnoot hout met strak design.",
